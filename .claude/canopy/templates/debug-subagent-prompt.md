...
Template for spawning canopy-debugger agent. The agent contains all debugging expertise - this template provides problem context only.
...
```python
Task(prompt=template, subagent_type="canopy-debugger", description="Debug UAT-001")
```
...
<prior_state>
Debug file: @.canopy/debug/{slug}.md
</prior_state>
