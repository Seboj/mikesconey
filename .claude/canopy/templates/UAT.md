...
Template for `.canopy/phases/XX-name/{phase_num}-UAT.md` — persistent UAT session tracking.
...
- This section feeds directly into /canopy:plan-phase --gaps
...
5. status → "diagnosed"
6. Ready for /canopy:plan-phase --gaps with root causes
...
**Creation:** When /canopy:verify-work starts new session
