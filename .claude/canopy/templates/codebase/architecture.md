...
Template for `.canopy/codebase/ARCHITECTURE.md` - captures conceptual code organization.
...
1. User runs: `canopy new-project`
...
**State Management:**
- File-based: All state lives in `.canopy/` directory
...
- Triggers: User runs `canopy <command>`
