...
This template is used by the complete-milestone workflow to create archive files in `.canopy/milestones/`.
...
_For current project status, see .canopy/ROADMAP.md_
...
- Save to `.canopy/milestones/v{VERSION}-{NAME}.md`
- Example: `.canopy/milestones/v1.0-mvp.md`
