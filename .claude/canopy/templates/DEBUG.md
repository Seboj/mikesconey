...
Template for `.canopy/debug/[slug].md` — active debug session tracking.
...
**Creation:** Immediately when /canopy:debug is called
...
**On resolution:**
- status → "resolved"
- Move file to .canopy/debug/resolved/ (only after user confirms fix)
